...
// ../protocol/dist/extension-runtime.js
...
// ../protocol/dist/operation-projection.js
...
function projectExtension(binding) {
  ...
  for (const descriptor of descriptors) {
    const entry = Object.entries(binding.verbs).find(([name, mapping2]) => mapping2.verb === descriptor.verb && (mapping2.qualifier ?? name) === (descriptor.qualifier?.value ?? name));
    if (entry === void 0)
      continue;
    ...
    const run = async (input, options) => {
      ...
      return runOperation({
        ...
        execute: async (context) => {
          ...
          }, context.signal === void 0 ? {} : { signal: context.signal }), binding, phase);
...
//# sourceMappingURL=chunk-XZXZHIBP.js.map
