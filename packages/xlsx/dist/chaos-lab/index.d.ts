...
type XlsxChaosStatus = "pass" | "warn" | "fail" | "blocked";
type XlsxChaosTier = "free" | "pro";
type XlsxChaosScenarioBucket = "free-safe" | "pro-only" | "shared";
...
interface XlsxChaosRuntimeMetadata {
    mode: XlsxChaosTier;
    buildType: string;
    packageName: string;
    keyPresent: boolean;
...
interface XlsxChaosScenarioResult {
    id: string;
    tier: XlsxChaosTier;
...
declare function runXlsxChaosLab(options?: XlsxChaosLabOptions): Promise<XlsxChaosLabReport>;
declare function formatXlsxChaosLabReport(report: XlsxChaosLabReport): string;
declare function renderXlsxChaosLabReport(options?: XlsxChaosLabOptions): Promise<string>;

export { formatXlsxChaosLabReport, renderXlsxChaosLabReport, runXlsxChaosLab };
export type { XlsxChaosEngine, XlsxChaosLabOptions, XlsxChaosLabReport, XlsxChaosRuntimeMetadata, XlsxChaosScenarioBucket, XlsxChaosScenarioResult, XlsxChaosStatus, XlsxChaosSummary, XlsxChaosTier };
