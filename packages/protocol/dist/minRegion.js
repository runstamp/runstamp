 ...
 */
export const MIN_REGION_STATIC = {
 ...
 */
export function minRegionFor(primitive, context) {
 ...
 */
export function remediationFor(primitive, actual, minimum) {
    const parts = [];
...
//# sourceMappingURL=minRegion.js.map