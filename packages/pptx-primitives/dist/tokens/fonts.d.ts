 ...
 */
export declare const BUNDLED_FONT_POOL: readonly string[];
 ...
 * Never throws.
 */
export declare function auditFontAvailability(tokens: ResolvedTokens): TokenWarning[];
/** Is the given family on the engine's system-font map? */
export declare function isBundledFont(family: string): boolean;
/** Look up an embedded font by family (case-insensitive), return the first
 *  matching regular (non-bold, non-italic) entry, or null. */
export declare function findEmbeddedRegular(family: string, fonts: readonly EmbeddedFont[]): EmbeddedFont | null;
