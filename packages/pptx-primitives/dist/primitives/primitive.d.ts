 ...
 */
export type Primitive<TInput> = (input: TInput, tokens: ResolvedTokens, region: Rect) => PrimitiveResult;
/** Narrow a PrimitiveResult to `fit` or throw. Useful in tests. */
export declare function assertFit(result: PrimitiveResult): void;
...
export declare function assertNonEmpty(result: PrimitiveResult, context: string): void;
