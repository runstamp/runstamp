...
export const sourceLine = (input, tokens, region) => {
    ...
    const lineHeightPx = estimateLineHeight(sizePt, caption.lineHeight !== undefined ? caption.lineHeight * scale : undefined, tokens, caption.family);
    const node = {
        kind: "text",
        rect: {
            left: region.left,
...
//# sourceMappingURL=sourceLine.js.map