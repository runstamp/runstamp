...
export interface WaterfallBarsInput {
  steps: Array<
    | { kind: "start" | "end"; label: string; value: number; valueLabel?: string }
    | { kind: "up" | "down"; label: string; value: number; valueLabel?: string }
  >;
...
export const waterfallBars: Primitive<WaterfallBarsInput> = (input, tokens, region) => {
...
function formatValue(value: number, kind: "start" | "end" | "up" | "down"): string {
