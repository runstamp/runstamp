...
export const sectionRibbon: Primitive<SectionRibbonInput> = (input, tokens, region) => {
...
function resolveChromeFill(
  role: ResolvedTokens["chrome"]["headerRibbon"]["fill"],
...
function chromeTextColor(
  fillRole: ResolvedTokens["chrome"]["headerRibbon"]["fill"],
  tokens: ResolvedTokens,
): string {
