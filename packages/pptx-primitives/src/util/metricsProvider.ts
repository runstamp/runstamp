...
export const NULL_METRICS_PROVIDER: MetricsProvider = () => null;
...
const TOKEN_PROVIDERS = new WeakMap<ResolvedTokens, MetricsProvider>();
...
export function attachMetricsProvider(
...
export function getMetricsProvider(tokens: ResolvedTokens): MetricsProvider | null {
...
export function detachMetricsProvider(tokens: ResolvedTokens): void {
