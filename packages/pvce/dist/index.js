...
// src/charts/collision-solver.ts
var DEFAULT_CONFIG = {
  minGap: 8,
  maxIterations: 50,
...
export { AccessibilityGenerator, AxisCollisionSolver, COLORBLIND_SAFE_COLORS, CollisionLevel, ColorPipeline, DEFAULT_PALETTE_COLORS, GlyphOracle, HAIRLINE_MIN_PT, MIN_GRAY_DIFFERENCE, Mulberry32, PVCECompiler, PathOptimizer, SNAP_THRESHOLD, SVGRenderer, VIRTUAL_CANVAS, WCAG_CONTRAST, accessibilityGenerator, chartToSVG, collisionSolver, colorPipeline, compareSceneGraphs, compileChart, createMonochromePalette, createSeededRandom, deriveSeedFromData, ensureMinStroke, generateChartAltText, generateNodeId, generateNodeIds, generateXMPMetadata, getContrastRatio, getMaxLabelWidth, glyphOracle, hashChartData, hashData, measureText, meetsContrastRequirement, optimizeLineChart, parseColor, pathOptimizer, pvceCompiler, renderToSVG, resolveAxisLabels, resolvePointLabels, shortHash, simplifyPath, simplifyPathString, snapToGrid, stripAnimations, svgRenderer, validateDeterminism, verifyNoAnimations };
